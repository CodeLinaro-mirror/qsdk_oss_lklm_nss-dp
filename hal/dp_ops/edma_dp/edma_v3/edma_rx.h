...
#define EDMA_RXDESC_PACKET_LEN_MASK		0xFFFF
...
#define EDMA_RXDESC_L3_OFFSET_MASK  	EDMA_RXDESC_GENMASK(22, 16)
#define EDMA_RXDESC_L3_OFFSET_GET(desc)	((le32_to_cpu(((desc)->word7)) & EDMA_RXDESC_L3_OFFSET_MASK) >> EDMA_RXDESC_L3_OFFSET_SHIFT)

#define EDMA_RXDESC_PID_SHIFT		23
#define EDMA_RXDESC_PID_MASK		EDMA_RXDESC_GENMASK(26, 23)
...
#define EDMA_RXDESC_DST_SHIFT		12
#define EDMA_RXDESC_DST_PORT		0x2 << EDMA_RXDESC_DST_SHIFT
...
#define EDMA_RXDESC_ACL_IDX_VALID_GET(desc)	(((le32_to_cpu((desc)->word1)) & 0x02000000) >> 25)

...
#define EDMA_REG_TXDESC_PASSTHR_UNREL(n)	(0xBA800 + (0x8 * (n)))
...
#define EDMA_REG_DDRQ_ENQ_DIS_AND_DEQ_DRP_OFF_CNT	6

#define EDMA_REG_DDRQ_ENQ_DIS_SET_ALL	0xFFFFFFFF
#define EDMA_REG_DDRQ_ENQ_DIS_RESET_ALL	0
...
#define EDMA_REG_DDRQ_ENQ_DIS_REG3_OFFSET	0x26C
#define EDMA_REG_DDRQ_ENQ_DIS_REG4_OFFSET	0x268
#define EDMA_REG_DDRQ_ENQ_DIS_REG5_OFFSET	0x27C

#define EDMA_REG_DDRQ_DEQ_DROP_SET_ALL	0xFFFFFFFF
#define EDMA_REG_DDRQ_DEQ_DROP_RESET_ALL	0

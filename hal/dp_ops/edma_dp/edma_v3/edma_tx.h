...
#define EDMA_TXDESC_DATA_LEN_SET_MASK	0xFFFF

#define EDMA_TXDESC_PASS_THROUGH_MODE_192B	0x0
#define EDMA_TXDESC_PASS_THROUGH_MODE_128B	0x1
#define EDMA_TXDESC_PASS_THROUGH_MODE_0B	0x2
#define EDMA_TXDESC_PASS_THROUGH_MODE_FULL_DATA	0x3

#define EDMA_TXDESC_PASS_THROUGH_MODE_SHIFT	14
#define EDMA_TXDESC_PASS_THROUGH_MODE_MASK	(0x3 << EDMA_TXDESC_PASS_THROUGH_MODE_SHIFT)
#define EDMA_TXDESC_PASS_THROUGH_MODE_SET(desc, x)	((desc)->word1 |= (((x) << EDMA_TXDESC_PASS_THROUGH_MODE_SHIFT) & EDMA_TXDESC_PASS_THROUGH_MODE_MASK))

#define EDMA_TXDESC_DATA_OFFSET_SHIFT1	0
#define EDMA_TXDESC_DATA_OFFSET_MASK1	(0xfff << EDMA_TXDESC_DATA_OFFSET_SHIFT1)
#define EDMA_TXDESC_DATA_OFFSET_SET(desc, x)	((desc)->word6 |= (((x) << EDMA_TXDESC_DATA_OFFSET_SHIFT1) & EDMA_TXDESC_DATA_OFFSET_MASK1))

#define EDMA_TXDESC_DATA_LEN_SET(desc, x)	((desc)->word5 |= ((x) & EDMA_TXDESC_DATA_LEN_SET_MASK))
...
#define EDMA_TX_SC_GEM_LOOKUP PPE_DRV_SC_BYPASS_ALL

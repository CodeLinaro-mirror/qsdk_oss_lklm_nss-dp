...
#define EDMA_TXDESC_PASS_THROUGH_MODE_SHIFT	12
#define EDMA_TXDESC_PASS_THROUGH_MODE_MASK	(0x3 << EDMA_TXDESC_PASS_THROUGH_MODE_SHIFT)
#define EDMA_TXDESC_PASS_THROUGH_MODE_SET(desc, x)	((desc)->word6 |= (((x) << EDMA_TXDESC_PASS_THROUGH_MODE_SHIFT) & EDMA_TXDESC_PASS_THROUGH_MODE_MASK))
